...
| HTTP 抓包 / 浏览器采样 / 请求重放 | anything-analyzer MCP（23816） | Reqable MCP、`js-reverse/`、或 jshookmcp |
...
| **LLM 应用 / AI Agent** | `llm-security/SKILL.md` — OWASP LLM + ASI Top 10 | Prompt 注入、Agent 安全 |
...
| "云安全/容器逃逸/K8s" | `cloud-k8s/SKILL.md` |
