...
- [apollo-router-plugin-creator](../notes/web-automation-frontend/apollo-router-plugin-creator.md) — Guide for writing Apollo Router native Rust plugins
- [apollo-server](../notes/web-automation-frontend/apollo-server.md) — Guide for building GraphQL servers with Apollo Server 5.x
...
- [browser-use](../notes/web-automation-frontend/browser-use.md) — Direct browser control via CDP for web interaction: automation, scraping, testing, screenshots, and site/app work
...
- [cue-kind-definition](../notes/web-automation-frontend/cue-kind-definition.md) — Author CUE kind definitions for grafana-app-sdk apps - schemas, versioning, field constraints, named type definitions, custom routes, and codegen configuration
...
- [react-19-plugin-migration](../notes/web-automation-frontend/react-19-plugin-migration.md) — Migrate a Grafana plugin to React 19 compatibility
